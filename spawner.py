...
ENV_BUNDLES = {
    ...
    "ant": ["Ant-v3"],
    "openai_suite": ["InvertedDoublePendulum-v2",
              "Hopper-v3",
              "Walker2d-v3",
              "HalfCheetah-v3",
              "Ant-v3"],
    "dmc_debug": ["Hopper-Hop-Feat-v0"],
    "thunderbluff": ["Hopper-Hop-Feat-v0",
                "Walker-Run-Feat-v0"],
    "raichu": ["Hopper-Hop-Feat-v0",
                "Cheetah-Run-Feat-v0",
                "Walker-Run-Feat-v0"],
    "stacker": ["Stacker-Stack_2-Feat-v0",
                "Stacker-Stack_4-Feat-v0"],
    "dmc_humanoid": ["Humanoid-Walk-Feat-v0",
